...
def get_args():
    ...
    parser.add_argument(
        '--config_backbone',
        type = str,
        default='/root/autodl-tmp/Ease_Code/cfgs/Mixup_models/Point-BERT.yaml',
    ...
    # some args
    parser.add_argument('--exp_name', type = str, default='Point-BERT_Shiyan', help = 'experiment name')
    ...
    args.experiment_path = os.path.join('./experiments', Path(args.config_backbone).stem, Path(args.config_backbone).parent.stem, args.exp_name)
    args.tfboard_path = os.path.join('./experiments', Path(args.config_backbone).stem, Path(args.config_backbone).parent.stem,'TFBoard' ,args.exp_name)
    args.log_name = Path(args.config_backbone).stem
